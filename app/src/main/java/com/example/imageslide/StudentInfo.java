...
public class StudentInfo extends AppCompatActivity {
    ...
    public void showStudent (View view){
           ...
           else if (view.getId()==R.id.cardView_19_ID){
               intent.putExtra("tag","2021-22");
               startActivity(intent);
           }
           else if (view.getId()==R.id.cardView_20_ID){
               intent.putExtra("tag","2022-23");
               startActivity(intent);
           }
           else if (view.getId()==R.id.cardView_21_ID){
               intent.putExtra("tag","2023-24");
               startActivity(intent);
           }
           else if (view.getId()==R.id.cardView_22_ID){
               intent.putExtra("tag","2024-25");
               startActivity(intent);
           }
           else if (view.getId()==R.id.cardView_23_ID){
               intent.putExtra("tag","2025-26");
               startActivity(intent);
           }
